...
os.system('clear')
print(lol)
fuckx=str(input("\033[1;91mENTER TOOL ONER NAME : "))
os.system('https://www.facebook.com/Noyshim.504')
name=fuckx.upper()

jalan('\x1b[1;31mNOYSHIM CYBER  NM CLONING TOOLS OPEN PLEASE WAIT ..........')
time.sleep(2)
os.system('clear')
loading()
...
def user():
    ...
    print(f"")   
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'    {P}[{H}√{P}] EXAMPLE    : {K}5000/15000/20000')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f"")
    limit = int(input(f'    %s[%s?%s] CRACK ID LIMIT : %s'%(N,K,N,H)))
    for nmbr in range(limit):
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
        print(f'{M}╔══[•] {NOYSHIM}WElCOME  MY TOOLS     : {RED}'+name)
        print(f'{M}║══[•] {NOYSHIM}TOTAL IDZ             : {RED}'+tl)
        print(f'{M}║══[•] {NOYSHIM}NUMBER YOU PUT        : {RED}'+gg)
        print(f'{M}║══[•] {NOYSHIM}PROCESS HAS BEEN STARTED')
        print(f'{M}╚══[•] {NOYSHIM}TO STOP PROCESS Ctrl + Z ')
        print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
        for love in user:
            uid = gg+"."+nn+love
